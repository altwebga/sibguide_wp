...
<div class="ts-group">
	<div class="x-row">
		<?php \Voxel\Form_Models\Select_Model::render( [
			'v-model' => 'config.cloudpayments_payments.order_approval',
		...
		<?php \Voxel\Form_Models\Select_Model::render( [
			'v-model' => 'config.cloudpayments_payments.billing_address_collection',
		...
		<?php \Voxel\Form_Models\Switcher_Model::render( [
			'v-model' => 'config.cloudpayments_payments.tax_id_collection.enabled',
		...
		<?php \Voxel\Form_Models\Switcher_Model::render( [
			'v-model' => 'config.cloudpayments_payments.phone_number_collection.enabled',
			'label' => 'Phone number collection',
			'classes' => 'x-col-12',
		] ) ?>

		<?php \Voxel\Form_Models\Switcher_Model::render( [
			'v-model' => 'config.cloudpayments_payments.promotion_codes.enabled',
