...
class One_Time_Payment_Controller extends \Voxel\Controllers\Base_Controller {
	...
	protected function hooks() {
		$this->on( 'voxel/membership/payment_intent.succeeded', '@one_time_payment_succeeded', 10, 2 );
	...
	protected function one_time_payment_succeeded( $payment_intent, $args = null ) {
		...
		if ( !! ( $args['preserve_additional_submissions'] ?? null ) && isset( $previous_details['additional_submissions'] ) ) {
			$details['additional_submissions'] = $previous_details['additional_submissions'];
		}
