...
class Role {
	...
	public function get_fields() {
		...
		if ( \Voxel\get( 'settings.membership.username_behavior' ) !== 'generate_from_email' ) {
			if ( ! ( $this->fields[ 'voxel:auth-username'] ?? null ) instanceof \Voxel\Membership\Fields\Username_Field ) {
				$this->fields[ 'voxel:auth-username'] = new \Voxel\Membership\Fields\Username_Field;
			}
		}
