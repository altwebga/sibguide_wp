...
* [#1480](https://github.com/cloudpayments/cloudpayments-php/pull/1480) Update generated code
...
* [#1344](https://github.com/cloudpayments/cloudpayments-php/pull/1344) API Updates
...
-   [#649](https://github.com/cloudpayments/cloudpayments-php/pull/649) Add support for `CustomerBalanceTransaction` resource and APIs
...
-   [#647](https://github.com/cloudpayments/cloudpayments-php/pull/647) Set the return type to static for more operations
...
-   [#568](https://github.com/cloudpayments/cloudpayments-php/pull/568) Enable persistent connections
...
-   [#561](https://github.com/cloudpayments/cloudpayments-php/pull/561) Add cast and some docs to telemetry introduced in 6.22.0/549

## 6.22.0 - 2018-11-15

-   [#549](https://github.com/cloudpayments/cloudpayments-php/pull/549) Add support for client telemetry

## 6.21.1 - 2018-11-12

-   [#548](https://github.com/cloudpayments/cloudpayments-php/pull/548) Don't mutate `Exception` class properties from `OAuthBase` error

## 6.21.0 - 2018-11-08

-   [#537](https://github.com/cloudpayments/cloudpayments-php/pull/537) Add new API endpoints for the `Invoice` resource.

## 6.20.1 - 2018-11-07

-   [#546](https://github.com/cloudpayments/cloudpayments-php/pull/546) Drop files from the Composer package that aren't needed in the release

## 6.20.0 - 2018-10-30

-   [#536](https://github.com/cloudpayments/cloudpayments-php/pull/536) Add support for the `Person` resource
-   [#541](https://github.com/cloudpayments/cloudpayments-php/pull/541) Add support for the `WebhookEndpoint` resource

## 6.19.5 - 2018-10-17

-   [#539](https://github.com/cloudpayments/cloudpayments-php/pull/539) Fix methods on `\Voxel\Vendor\CloudPayments\PaymentIntent` to properly pass arguments to the API.

## 6.19.4 - 2018-10-11

-   [#534](https://github.com/cloudpayments/cloudpayments-php/pull/534) Fix PSR-4 autoloading for `\Voxel\Vendor\CloudPayments\FileUpload` class alias

## 6.19.3 - 2018-10-09

-   [#530](https://github.com/cloudpayments/cloudpayments-php/pull/530) Add constants for `flow` (`FLOW_*`), `status` (`STATUS_*`) and `usage` (`USAGE_*`) on `\Voxel\Vendor\CloudPayments\Source`

## 6.19.2 - 2018-10-08

-   [#531](https://github.com/cloudpayments/cloudpayments-php/pull/531) Store HTTP response headers in case-insensitive array

## 6.19.1 - 2018-09-25

-   [#526](https://github.com/cloudpayments/cloudpayments-php/pull/526) Ignore null values in request parameters

## 6.19.0 - 2018-09-24

-   [#523](https://github.com/cloudpayments/cloudpayments-php/pull/523) Add support for CloudPayments Terminal

## 6.18.0 - 2018-09-24

-   [#520](https://github.com/cloudpayments/cloudpayments-php/pull/520) Rename `\Voxel\Vendor\CloudPayments\FileUpload` to `\Voxel\Vendor\CloudPayments\File`

## 6.17.2 - 2018-09-18

-   [#522](https://github.com/cloudpayments/cloudpayments-php/pull/522) Fix warning when adding a new additional owner to an existing array

## 6.17.1 - 2018-09-14

-   [#517](https://github.com/cloudpayments/cloudpayments-php/pull/517) Integer-index encode all sequential arrays

## 6.17.0 - 2018-09-05

-   [#514](https://github.com/cloudpayments/cloudpayments-php/pull/514) Add support for reporting resources

## 6.16.0 - 2018-08-23

-   [#509](https://github.com/cloudpayments/cloudpayments-php/pull/509) Add support for usage record summaries

## 6.15.0 - 2018-08-03

-   [#504](https://github.com/cloudpayments/cloudpayments-php/pull/504) Add cancel support for topups

## 6.14.0 - 2018-08-02

-   [#505](https://github.com/cloudpayments/cloudpayments-php/pull/505) Add support for file links

## 6.13.0 - 2018-07-31

-   [#502](https://github.com/cloudpayments/cloudpayments-php/pull/502) Add `isDeleted()` method to `\Voxel\Vendor\CloudPayments\CloudPaymentsObject`

## 6.12.0 - 2018-07-28

-   [#501](https://github.com/cloudpayments/cloudpayments-php/pull/501) Add support for scheduled query runs (`\Voxel\Vendor\CloudPayments\Sigma\ScheduledQueryRun`) for Sigma

## 6.11.0 - 2018-07-26

-   [#500](https://github.com/cloudpayments/cloudpayments-php/pull/500) Add support for CloudPayments Issuing

## 6.10.4 - 2018-07-19

-   [#498](https://github.com/cloudpayments/cloudpayments-php/pull/498) Internal improvements to the `\Voxel\Vendor\CloudPayments\ApiResource.classUrl()` method

## 6.10.3 - 2018-07-16

-   [#497](https://github.com/cloudpayments/cloudpayments-php/pull/497) Use HTTP/2 only for HTTPS requests

## 6.10.2 - 2018-07-11

-   [#494](https://github.com/cloudpayments/cloudpayments-php/pull/494) Enable HTTP/2 support

## 6.10.1 - 2018-07-10

-   [#493](https://github.com/cloudpayments/cloudpayments-php/pull/493) Add PHPDoc for `auto_advance` on `\Voxel\Vendor\CloudPayments\Invoice`

## 6.10.0 - 2018-06-28

-   [#488](https://github.com/cloudpayments/cloudpayments-php/pull/488) Add support for `$appPartnerId` to `CloudPayments::setAppInfo()`

## 6.9.0 - 2018-06-28

-   [#487](https://github.com/cloudpayments/cloudpayments-php/pull/487) Add support for payment intents

## 6.8.2 - 2018-06-24

-   [#486](https://github.com/cloudpayments/cloudpayments-php/pull/486) Make `Account.deauthorize()` return the `CloudPaymentsObject` from the API

## 6.8.1 - 2018-06-13

-   [#472](https://github.com/cloudpayments/cloudpayments-php/pull/472) Added phpDoc for `ApiRequestor` and others, especially regarding thrown errors

## 6.8.0 - 2018-06-13

-   [#481](https://github.com/cloudpayments/cloudpayments-php/pull/481) Add new `\Voxel\Vendor\CloudPayments\Discount` and `\Voxel\Vendor\CloudPayments\OrderItem` classes, add more PHPDoc describing object attributes

## 6.7.4 - 2018-05-29

-   [#480](https://github.com/cloudpayments/cloudpayments-php/pull/480) PHPDoc changes for API version 2018-05-21 and the addition of the new `CHARGE_EXPIRED` event type

## 6.7.3 - 2018-05-28

-   [#479](https://github.com/cloudpayments/cloudpayments-php/pull/479) Fix unnecessary traits on `\Voxel\Vendor\CloudPayments\InvoiceLineItem`

## 6.7.2 - 2018-05-28

-   [#471](https://github.com/cloudpayments/cloudpayments-php/pull/471) Add `OBJECT_NAME` constant to all API resource classes, add `\Voxel\Vendor\CloudPayments\InvoiceLineItem` class

## 6.7.1 - 2018-05-13

-   [#468](https://github.com/cloudpayments/cloudpayments-php/pull/468) Update fields in PHP docs for accuracy

## 6.7.0 - 2018-05-09

-   [#466](https://github.com/cloudpayments/cloudpayments-php/pull/466) Add support for issuer fraud records

## 6.6.0 - 2018-04-11

-   [#460](https://github.com/cloudpayments/cloudpayments-php/pull/460) Add support for flexible billing primitives

## 6.5.0 - 2018-04-05

-   [#461](https://github.com/cloudpayments/cloudpayments-php/pull/461) Don't zero keys on non-`metadata` subobjects

## 6.4.2 - 2018-03-17

-   [#458](https://github.com/cloudpayments/cloudpayments-php/pull/458) Add PHPDoc for `account` on `\Voxel\Vendor\CloudPayments\Event`

## 6.4.1 - 2018-03-02

-   [#455](https://github.com/cloudpayments/cloudpayments-php/pull/455) Fix namespaces in PHPDoc
-   [#456](https://github.com/cloudpayments/cloudpayments-php/pull/456) Fix namespaces for some exceptions

## 6.4.0 - 2018-02-28

-   [#453](https://github.com/cloudpayments/cloudpayments-php/pull/453) Add constants for `reason` (`REASON_*`) and `status` (`STATUS_*`) on `\Voxel\Vendor\CloudPayments\Dispute`

## 6.3.2 - 2018-02-27

-   [#452](https://github.com/cloudpayments/cloudpayments-php/pull/452) Add PHPDoc for `amount_paid` and `amount_remaining` on `\Voxel\Vendor\CloudPayments\Invoice`

## 6.3.1 - 2018-02-26

-   [#443](https://github.com/cloudpayments/cloudpayments-php/pull/443) Add event types as constants to `\Voxel\Vendor\CloudPayments\Event` class

## 6.3.0 - 2018-02-23

-   [#450](https://github.com/cloudpayments/cloudpayments-php/pull/450) Add support for `code` attribute on all CloudPayments exceptions

## 6.2.0 - 2018-02-21

-   [#440](https://github.com/cloudpayments/cloudpayments-php/pull/440) Add support for topups
-   [#442](https://github.com/cloudpayments/cloudpayments-php/pull/442) Fix PHPDoc for `\Voxel\Vendor\CloudPayments\Error\SignatureVerification`

## 6.1.0 - 2018-02-12

-   [#435](https://github.com/cloudpayments/cloudpayments-php/pull/435) Fix header persistence on `Collection` objects
-   [#436](https://github.com/cloudpayments/cloudpayments-php/pull/436) Introduce new `Idempotency` error class
...
*   `\Voxel\Vendor\CloudPayments\AttachedObject` no longer exists. Attributes that used to be instances of `\Voxel\Vendor\CloudPayments\AttachedObject` (such as `metadata`) are now instances of `\Voxel\Vendor\CloudPayments\CloudPaymentsObject`.

-   Attributes that used to be PHP arrays (such as `legal_entity->additional_owners` on `\Voxel\Vendor\CloudPayments\Account` instances) are now instances of `\Voxel\Vendor\CloudPayments\CloudPaymentsObject`, except when they are empty. `\Voxel\Vendor\CloudPayments\CloudPaymentsObject` has array semantics so this should not be an issue unless you are actively checking types.

*   `\Voxel\Vendor\CloudPayments\Collection` now derives from `\Voxel\Vendor\CloudPayments\CloudPaymentsObject` rather than from `\Voxel\Vendor\CloudPayments\ApiResource`.

Pull requests included in this release:

-   [#410](https://github.com/cloudpayments/cloudpayments-php/pull/410) Drop support for PHP 5.3
-   [#411](https://github.com/cloudpayments/cloudpayments-php/pull/411) Use traits for common API operations
-   [#414](https://github.com/cloudpayments/cloudpayments-php/pull/414) Use short array syntax
-   [#404](https://github.com/cloudpayments/cloudpayments-php/pull/404) Fix serialization logic
-   [#417](https://github.com/cloudpayments/cloudpayments-php/pull/417) Remove `ExternalAccount` class
-   [#418](https://github.com/cloudpayments/cloudpayments-php/pull/418) Increase test coverage
-   [#421](https://github.com/cloudpayments/cloudpayments-php/pull/421) Update CA bundle and add script for future updates
-   [#422](https://github.com/cloudpayments/cloudpayments-php/pull/422) Use vendored CA bundle for all requests
-   [#428](https://github.com/cloudpayments/cloudpayments-php/pull/428) Support for automatic request retries

## 5.9.2 - 2018-02-07

-   [#431](https://github.com/cloudpayments/cloudpayments-php/pull/431) Update PHPDoc @property tags for latest API version

## 5.9.1 - 2018-02-06

-   [#427](https://github.com/cloudpayments/cloudpayments-php/pull/427) Add and update PHPDoc @property tags on all API resources

## 5.9.0 - 2018-01-17

-   [#421](https://github.com/cloudpayments/cloudpayments-php/pull/421) Updated bundled CA certificates
-   [#423](https://github.com/cloudpayments/cloudpayments-php/pull/423) Escape unsanitized input in OAuth example

## 5.8.0 - 2017-12-20

-   [#403](https://github.com/cloudpayments/cloudpayments-php/pull/403) Add `__debugInfo()` magic method to `CloudPaymentsObject`

## 5.7.0 - 2017-11-28

-   [#390](https://github.com/cloudpayments/cloudpayments-php/pull/390) Remove some unsupported API methods
-   [#391](https://github.com/cloudpayments/cloudpayments-php/pull/391) Alphabetize the list of API resources in `Util::convertToCloudPaymentsObject()` and add missing resources
-   [#393](https://github.com/cloudpayments/cloudpayments-php/pull/393) Fix expiry date update for card sources

## 5.6.0 - 2017-10-31

-   [#386](https://github.com/cloudpayments/cloudpayments-php/pull/386) Support for exchange rates APIs

## 5.5.1 - 2017-10-30

-   [#387](https://github.com/cloudpayments/cloudpayments-php/pull/387) Allow `personal_address_kana` and `personal_address_kanji` to be updated on an account

## 5.5.0 - 2017-10-27

-   [#385](https://github.com/cloudpayments/cloudpayments-php/pull/385) Support for listing source transactions

## 5.4.0 - 2017-10-24

-   [#383](https://github.com/cloudpayments/cloudpayments-php/pull/383) Add static methods to manipulate resources from parent
...
-   [#378](https://github.com/cloudpayments/cloudpayments-php/pull/378) Rename source `delete` to `detach` (and deprecate the former)
...
-   Add `\Voxel\Vendor\CloudPayments\CloudPayments::setLogger()` to support an external PSR-3 compatible logger
...
-   Add `CloudPayments::setAppInfo` to allow plugins to register user agent information
...
-   Fix bug `refreshFrom` on `CloudPaymentsObject` would not take an `$opts` array
...
-   Allow global account ID to be set with `CloudPayments::setAccountId()`
...
-   Products, SKUs, and Orders -- https://cloudpayments.com/relay
...
-   Rename `\Voxel\Vendor\CloudPayments\Object` to `\Voxel\Vendor\CloudPayments\CloudPaymentsObject` (PHP 7 compatibility)
-   Rename `getCode` and `getParam` in exceptions to `getCloudPaymentsCode` and `getCloudPaymentsParam`
-   Add support for calling `json_encode` on CloudPayments objects in PHP 5.4+
-   Start supporting/testing PHP 7

## 2.3.0 - 2015-07-06

-   Add request ID to all CloudPayments exceptions
...
-   Switched to CloudPayments namespace instead of CloudPayments\_ class name prefiexes (thanks @chadicus!)
-   Switched tests to PHPUnit (thanks @chadicus!)
-   Switched style guide to PSR2 (thanks @chadicus!)
-   Added \$opts hash to the end of most methods: this permits passing 'idempotency_key', 'cloudpayments_account', or 'cloudpayments_version'. The last 2 will persist across multiple object loads.
...
-   Coupons now are backed by a `CloudPayments_Coupon` instead of `CloudPayments_Object`, and support updating metadata
...
-   Add CloudPayments_RateLimitError for catching rate limit errors.
...
-   Add support for multiple cards API (CloudPayments API version 2013-07-12: https://cloudpayments.com/docs/upgrades#2013-07-05)
...
-   Don't re-encode strings that are already encoded in UTF-8. If you were previously using plan or coupon objects with UTF-8 IDs, they may have been treated as ISO-8859-1 (Latin-1) and encoded to UTF-8 a 2nd time. You may now need to pass the IDs to utf8_encode before passing them to CloudPayments_Plan::retrieve or CloudPayments_Coupon::retrieve.
-   Ensure that all input is encoded in UTF-8 before submitting it to CloudPayments's servers. (github issue #27)

## 1.7.13 - 2013-02-01

-   Add support for passing options when retrieving CloudPayments objects e.g., CloudPayments_Charge::retrieve(array("id"=>"foo", "expand" => array("customer"))); CloudPayments_Charge::retrieve("foo") will continue to work

## 1.7.12 - 2013-01-15

-   Add support for setting a CloudPayments API version override
...
-   Change internal function names so that CloudPayments_SingletonApiRequest is E_STRICT-clean (github issue #16)

## 1.7.4 - 2012-08-21

-   Bugfix so that CloudPayments objects (e.g. Customer, Charge objects) used in API calls are transparently converted to their object IDs
...
-   Make clearer that you should be including lib/CloudPayments.php, not test/CloudPayments.php (github issue #14)

## 1.7.1 - 2012-05-24

-   Add missing argument to CloudPayments_InvalidRequestError constructor in CloudPayments_ApiResource::instanceUrl. Fixes a warning when CloudPayments_ApiResource::instanceUrl is called on a resource with no ID (fix issue #12)

## 1.7.0 - 2012-05-17

-   Support Composer and Packagist (github issue #9)
-   Add new deleteDiscount method to CloudPayments_Customer
-   Add new Transfer resource
-   Switch from using HTTP Basic auth to Bearer auth. (Note: CloudPayments will support Basic auth for the indefinite future, but recommends Bearer auth when possible going forward)
