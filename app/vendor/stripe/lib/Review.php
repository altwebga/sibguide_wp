 ...
 * <a href="https://cloudpayments.com/docs/radar/reviews">here</a>.
 *
 * @property string $id Unique identifier for the object.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property null|string $billing_zip The ZIP or postal code of the card used, if applicable.
 * @property null|string|\Voxel\Vendor\CloudPayments\Charge $charge The charge associated with this review.
 ...
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $ip_address_location Information related to the location of the payment. Note that this information is an approximation and attempts to locate the nearest population center - it should not be used to determine a specific address.
 ...
 * @property null|string|\Voxel\Vendor\CloudPayments\PaymentIntent $payment_intent The PaymentIntent ID associated with this review, if one exists.
 ...
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $session Information related to the browsing session of the user who initiated the payment.
 */
class Review extends ApiResource
{
     ...
     *
     * @see https://cloudpayments.com/docs/api/radar/reviews/object
     */
     ...
     *
     * @return \Voxel\Vendor\CloudPayments\Review the approved review
     */
