...
/**
 * You can configure <a href="https://cloudpayments.com/docs/webhooks/">webhook endpoints</a> via the API to be
 * notified about events that happen in your CloudPayments account or connected
 * accounts.
 *
 * Most users configure webhooks from <a href="https://dashboard.cloudpayments.com/webhooks">the dashboard</a>, which provides a user interface for registering and testing your webhook endpoints.
 *
 * Related guide: <a href="https://cloudpayments.com/docs/webhooks/configure">Setting up webhooks</a>
 *
 ...
 * @property null|string $secret The endpoint's secret, used to generate <a href="https://cloudpayments.com/docs/webhooks/signatures">webhook signatures</a>. Only returned at creation.
