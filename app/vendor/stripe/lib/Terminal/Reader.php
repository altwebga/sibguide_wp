 ...
 * @property null|\Voxel\Vendor\Stripe\StripeObject $action The most recent action performed by the reader.
 ...
 * @property null|string|\Voxel\Vendor\Stripe\Terminal\Location $location The location identifier of the reader.
...
class Reader extends \Voxel\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \Voxel\Vendor\Stripe\Terminal\Reader the canceled reader
     */
     ...
     * @throws \Voxel\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Voxel\Vendor\Stripe\Terminal\Reader the processed reader
     */
     ...
     * @throws \Voxel\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Voxel\Vendor\Stripe\Terminal\Reader the refunded reader
     */
     ...
     * @throws \Voxel\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Voxel\Vendor\Stripe\Terminal\Reader the seted reader
     */
