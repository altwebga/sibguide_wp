...
/**
 * CloudPayments needs to collect certain pieces of information about each account
 ...
 * @property \Voxel\Vendor\CloudPayments\CloudPaymentsObject $supported_bank_account_currencies Currencies that can be accepted in the specific country (for transfers).
 * @property string[] $supported_payment_currencies Currencies that can be accepted in the specified country (for payments).
 * @property string[] $supported_payment_methods Payment methods available in the specified country. You may need to enable some payment methods (e.g., <a href="https://cloudpayments.com/docs/ach">ACH</a>) on your account before they appear in this list. The <code>cloudpayments</code> payment method refers to <a href="https://cloudpayments.com/docs/connect/destination-charges">charging through your platform</a>.
 * @property string[] $supported_transfer_countries Countries that can accept transfers from the specified country.
 * @property \Voxel\Vendor\CloudPayments\CloudPaymentsObject $verification_fields
 */
