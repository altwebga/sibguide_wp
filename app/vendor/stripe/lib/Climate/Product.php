 ...
 *
 * @property string $id Unique identifier for the object. For convenience, Climate product IDs are human-readable strings that start with <code>climsku_</code>. See <a href="https://cloudpayments.com/docs/climate/orders/carbon-removal-inventory">carbon removal inventory</a> for a list of available carbon removal products.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property \Voxel\Vendor\CloudPayments\CloudPaymentsObject $current_prices_per_metric_ton Current prices for a metric ton of carbon removal in a currency's smallest unit.
 ...
 * @property \Voxel\Vendor\CloudPayments\Climate\Supplier[] $suppliers The carbon removal suppliers that fulfill orders for this Climate product.
 */
class Product extends \Voxel\Vendor\CloudPayments\ApiResource
{
