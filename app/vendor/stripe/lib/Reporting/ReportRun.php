 ...
 * specific run parameters. Once the object is created, CloudPayments begins processing the report.
 * When the report has finished running, it will give you a reference to a file
 * where you can retrieve your results. For an overview, see
 * <a href="https://cloudpayments.com/docs/reporting/statements/api">API Access to Reports</a>.
 *
 ...
 * @property \Voxel\Vendor\CloudPayments\CloudPaymentsObject $parameters
 * @property string $report_type The ID of the <a href="https://cloudpayments.com/docs/reports/report-types">report type</a> to run, such as <code>&quot;balance.summary.1&quot;</code>.
 * @property null|\Voxel\Vendor\CloudPayments\File $result The file object representing the result of the report run (populated when <code>status=succeeded</code>).
 ...
 */
class ReportRun extends \Voxel\Vendor\CloudPayments\ApiResource
{
