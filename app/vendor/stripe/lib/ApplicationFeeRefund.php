 ...
 * the CloudPayments account from which the fee was originally collected.
 *
 * Related guide: <a href="https://cloudpayments.com/docs/connect/destination-charges#refunding-app-fee">Refunding application fees</a>
 *
 ...
 * @property string|\Voxel\Vendor\CloudPayments\ApplicationFee $fee ID of the application fee that was refunded.
...
class ApplicationFeeRefund extends ApiResource
{
    ...
    /**
     * @return string the API URL for this CloudPayments refund
     */
