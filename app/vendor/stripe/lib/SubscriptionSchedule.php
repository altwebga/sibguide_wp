 ...
 *
 * Related guide: <a href="https://cloudpayments.com/docs/billing/subscriptions/subscription-schedules">Subscription schedules</a>
 *
 * @property string $id Unique identifier for the object.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property null|string|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $application ID of the Connect Application that created the schedule.
 ...
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $current_phase Object representing the start and end dates for the current phase of the subscription schedule, if it is <code>active</code>.
 * @property string|\Voxel\Vendor\CloudPayments\Customer $customer ID of the customer who owns the subscription schedule.
 * @property \Voxel\Vendor\CloudPayments\CloudPaymentsObject $default_settings
 ...
 * @property \Voxel\Vendor\CloudPayments\CloudPaymentsObject[] $phases Configuration for the subscription schedule's phases.
 ...
 * @property string $status The present status of the subscription schedule. Possible values are <code>not_started</code>, <code>active</code>, <code>completed</code>, <code>released</code>, and <code>canceled</code>. You can read more about the different states in our <a href="https://cloudpayments.com/docs/billing/subscriptions/subscription-schedules">behavior guide</a>.
 * @property null|string|\Voxel\Vendor\CloudPayments\Subscription $subscription ID of the subscription managed by the subscription schedule.
 * @property null|string|\Voxel\Vendor\CloudPayments\TestHelpers\TestClock $test_clock ID of the test clock this subscription schedule belongs to.
 */
class SubscriptionSchedule extends ApiResource
{
     ...
     *
     * @return \Voxel\Vendor\CloudPayments\SubscriptionSchedule the canceled subscription schedule
     */
     ...
     * @throws \Voxel\Vendor\CloudPayments\Exception\ApiErrorException if the request fails
     *
     * @return \Voxel\Vendor\CloudPayments\SubscriptionSchedule the released subscription schedule
     */
