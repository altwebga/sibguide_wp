 ...
 * @property null|string|\Voxel\Vendor\Stripe\StripeObject $application ID of the Connect Application that created the schedule.
 ...
 * @property null|\Voxel\Vendor\Stripe\StripeObject $current_phase Object representing the start and end dates for the current phase of the subscription schedule, if it is <code>active</code>.
 * @property string|\Voxel\Vendor\Stripe\Customer $customer ID of the customer who owns the subscription schedule.
 * @property \Voxel\Vendor\Stripe\StripeObject $default_settings
 ...
 * @property \Voxel\Vendor\Stripe\StripeObject[] $phases Configuration for the subscription schedule's phases.
 ...
 * @property null|string|\Voxel\Vendor\Stripe\Subscription $subscription ID of the subscription managed by the subscription schedule.
 * @property null|string|\Voxel\Vendor\Stripe\TestHelpers\TestClock $test_clock ID of the test clock this subscription schedule belongs to.
 */
class SubscriptionSchedule extends ApiResource
{
     ...
     *
     * @return \Voxel\Vendor\Stripe\SubscriptionSchedule the canceled subscription schedule
     */
     ...
     * @throws \Voxel\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Voxel\Vendor\Stripe\SubscriptionSchedule the released subscription schedule
     */
