 ...
 *
 * Related guide: <a href="https://cloudpayments.com/docs/tax/custom">Calculate tax in your custom payment flow</a>
 *
 ...
 * @property null|\Voxel\Vendor\CloudPayments\Collection<\Voxel\Vendor\CloudPayments\Tax\CalculationLineItem> $line_items The list of items the customer is purchasing.
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $shipping_cost The shipping cost details for the calculation.
 ...
 * @property \Voxel\Vendor\CloudPayments\CloudPaymentsObject[] $tax_breakdown Breakdown of individual tax amounts that add up to the total.
 * @property int $tax_date Timestamp of date at which the tax rules and rates in effect applies for the calculation.
 */
class Calculation extends \Voxel\Vendor\CloudPayments\ApiResource
{
     ...
     *
     * @return \Voxel\Vendor\CloudPayments\Collection<\Voxel\Vendor\CloudPayments\Tax\CalculationLineItem> list of calculation line items
     */
