...
/**
 * You can add one or multiple tax IDs to a <a href="https://cloudpayments.com/docs/api/customers">customer</a> or account.
 * Customer and account tax IDs get displayed on related invoices and credit notes.
 *
 * Related guides: <a href="https://cloudpayments.com/docs/billing/taxes/tax-ids">Customer tax identification numbers</a>, <a href="https://cloudpayments.com/docs/invoicing/connect#account-tax-ids">Account tax IDs</a>
 *
 ...
 * @property null|string|\Voxel\Vendor\CloudPayments\Customer $customer ID of the customer.
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $owner The account or customer the tax ID belongs to.
 ...
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $verification Tax ID verification information.
 */
