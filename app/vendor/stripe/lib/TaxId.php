 ...
 * @property null|string|\Voxel\Vendor\Stripe\Customer $customer ID of the customer.
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property null|\Voxel\Vendor\Stripe\StripeObject $owner The account or customer the tax ID belongs to.
 ...
 * @property null|\Voxel\Vendor\Stripe\StripeObject $verification Tax ID verification information.
 */
