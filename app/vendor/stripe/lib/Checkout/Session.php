...
namespace Voxel\Vendor\CloudPayments\Checkout;

/**
 * A Checkout Session represents your customer's session as they pay for
 * one-time purchases or subscriptions through <a href="https://cloudpayments.com/docs/payments/checkout">Checkout</a>
 * or <a href="https://cloudpayments.com/docs/payments/payment-links">Payment Links</a>. We recommend creating a
 * new Session each time your customer attempts to pay.
 *
 * Once payment is successful, the Checkout Session will contain a reference
 * to the <a href="https://cloudpayments.com/docs/api/customers">Customer</a>, and either the successful
 * <a href="https://cloudpayments.com/docs/api/payment_intents">PaymentIntent</a> or an active
 * <a href="https://cloudpayments.com/docs/api/subscriptions">Subscription</a>.
 *
 * You can create a Checkout Session on your server and redirect to its URL
 * to begin Checkout.
 *
 * Related guide: <a href="https://cloudpayments.com/docs/checkout/quickstart">Checkout quickstart</a>
 *
 * @property string $id Unique identifier for the object.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $after_expiration When set, provides configuration for actions to take if this Checkout Session expires.
 ...
 * @property null|string $client_secret Client secret to be used when initializing CloudPayments.js embedded checkout.
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $consent Results of <code>consent_collection</code> for this session.
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $consent_collection When set, provides configuration for the Checkout Session to gather active consent from customers.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property null|string $currency Three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a>, in lowercase. Must be a <a href="https://cloudpayments.com/docs/currencies">supported currency</a>.
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $currency_conversion Currency conversion details for automatic currency conversion sessions
 ...
 * @property null|string|\Voxel\Vendor\CloudPayments\Customer $customer The ID of the customer for this Session. For Checkout Sessions in <code>subscription</code> mode or Checkout Sessions with <code>customer_creation</code> set as <code>always</code> in <code>payment</code> mode, Checkout will create a new customer object based on information provided during the payment flow unless an existing customer was provided when the Session was created.
 ...
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $customer_details The customer details including the customer's tax exempt status and the customer's tax IDs. Only the customer's email is present on Sessions in <code>setup</code> mode.
 ...
 * @property null|string|\Voxel\Vendor\CloudPayments\Invoice $invoice ID of the invoice created by the Checkout Session, if it exists.
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $invoice_creation Details on the state of invoice creation for the Checkout Session.
 * @property null|\Voxel\Vendor\CloudPayments\Collection<\Voxel\Vendor\CloudPayments\LineItem> $line_items The line items purchased by the customer.
 ...
 * @property null|string|\Voxel\Vendor\CloudPayments\PaymentIntent $payment_intent The ID of the PaymentIntent for Checkout Sessions in <code>payment</code> mode.
 * @property null|string|\Voxel\Vendor\CloudPayments\PaymentLink $payment_link The ID of the Payment Link that created this Session.
 * @property null|string $payment_method_collection Configure whether a Checkout Session should collect a payment method.
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $payment_method_configuration_details Information about the payment method configuration used for this Checkout session if using dynamic payment methods.
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $payment_method_options Payment-method-specific configuration for the PaymentIntent or SetupIntent of this CheckoutSession.
 ...
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $phone_number_collection
 * @property null|string $recovered_from The ID of the original expired Checkout Session that triggered the recovery flow.
 * @property null|string $redirect_on_completion Applies to Checkout Sessions with <code>ui_mode: embedded</code>. By default, CloudPayments will always redirect to your return_url after a successful confirmation. If you set <code>redirect_on_completion: 'if_required'</code>, then we will only redirect if your user chooses a redirect-based payment method.
 ...
 * @property null|string|\Voxel\Vendor\CloudPayments\SetupIntent $setup_intent The ID of the SetupIntent for Checkout Sessions in <code>setup</code> mode.
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $shipping_address_collection When set, provides configuration for Checkout to collect a shipping address from a customer.
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $shipping_cost The details of the customer cost of shipping, including the customer chosen ShippingRate.
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $shipping_details Shipping information for this Checkout Session.
 * @property \Voxel\Vendor\CloudPayments\CloudPaymentsObject[] $shipping_options The shipping rate options applied to this Session.
 ...
 * @property null|string|\Voxel\Vendor\CloudPayments\Subscription $subscription The ID of the subscription for Checkout Sessions in <code>subscription</code> mode.
 ...
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $tax_id_collection
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $total_details Tax and discount details for the computed total amount.
 * @property null|string $ui_mode The UI mode of the Session. Can be <code>hosted</code> (default) or <code>embedded</code>.
 * @property null|string $url The URL to the Checkout Session. Redirect customers to this URL to take them to Checkout. If you’re using <a href="https://cloudpayments.com/docs/payments/checkout/custom-domains">Custom Domains</a>, the URL will use your subdomain. Otherwise, it’ll use <code>checkout.cloudpayments.com.</code> This value is only present when the session is active.
 */
class Session extends \Voxel\Vendor\CloudPayments\ApiResource
{
     ...
     *
     * @return \Voxel\Vendor\CloudPayments\Checkout\Session the expired session
     */
