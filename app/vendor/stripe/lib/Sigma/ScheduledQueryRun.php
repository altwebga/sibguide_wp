...
namespace Voxel\Vendor\CloudPayments\Sigma;

/**
 * If you have <a href="https://cloudpayments.com/docs/sigma/scheduled-queries">scheduled a Sigma query</a>, you'll
 ...
 * @property int $data_load_time When the query was run, Sigma contained a snapshot of your CloudPayments data at this time.
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $error
 * @property null|\Voxel\Vendor\CloudPayments\File $file The file object representing the results of the query.
 ...
 */
class ScheduledQueryRun extends \Voxel\Vendor\CloudPayments\ApiResource
{
