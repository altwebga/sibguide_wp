 ...
 * @property null|\Voxel\Vendor\Stripe\StripeObject $document Result from a document check
 * @property null|\Voxel\Vendor\Stripe\StripeObject $id_number Result from an id_number check
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property null|\Voxel\Vendor\Stripe\StripeObject $options
 * @property null|\Voxel\Vendor\Stripe\StripeObject $selfie Result from a selfie check
