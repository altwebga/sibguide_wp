 ...
 * @property null|\Voxel\Vendor\Stripe\StripeObject $last_error If present, this property tells you the last error encountered when processing the verification.
 * @property null|string|\Voxel\Vendor\Stripe\Identity\VerificationReport $last_verification_report ID of the most recent VerificationReport. <a href="https://stripe.com/docs/identity/verification-sessions#results">Learn more about accessing detailed verification results.</a>
 ...
 * @property null|\Voxel\Vendor\Stripe\StripeObject $options A set of options for the session’s verification checks.
 * @property null|\Voxel\Vendor\Stripe\StripeObject $redaction Redaction status of this VerificationSession. If the VerificationSession is not redacted, this field will be null.
 ...
 * @property null|\Voxel\Vendor\Stripe\StripeObject $verified_outputs The user’s verified data.
 */
class VerificationSession extends \Voxel\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \Voxel\Vendor\Stripe\Identity\VerificationSession the canceled verification session
     */
     ...
     * @throws \Voxel\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Voxel\Vendor\Stripe\Identity\VerificationSession the redacted verification session
     */
