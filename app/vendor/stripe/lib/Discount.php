...
/**
 * A discount represents the actual application of a <a href="https://cloudpayments.com/docs/api#coupons">coupon</a> or <a href="https://cloudpayments.com/docs/api#promotion_codes">promotion code</a>.
 * It contains information about when the discount began, when it will end, and what it is applied to.
 *
 * Related guide: <a href="https://cloudpayments.com/docs/billing/subscriptions/discounts">Applying discounts to subscriptions</a>
 *
 ...
 * @property \Voxel\Vendor\CloudPayments\Coupon $coupon A coupon contains information about a percent-off or amount-off discount you might want to apply to a customer. Coupons may be applied to <a href="https://cloudpayments.com/docs/api#subscriptions">subscriptions</a>, <a href="https://cloudpayments.com/docs/api#invoices">invoices</a>, <a href="https://cloudpayments.com/docs/api/checkout/sessions">checkout sessions</a>, <a href="https://cloudpayments.com/docs/api#quotes">quotes</a>, and more. Coupons do not work with conventional one-off <a href="https://cloudpayments.com/docs/api#create_charge">charges</a> or <a href="https://cloudpayments.com/docs/api/payment_intents">payment intents</a>.
 * @property null|string|\Voxel\Vendor\CloudPayments\Customer $customer The ID of the customer associated with this discount.
 ...
 * @property null|string|\Voxel\Vendor\CloudPayments\PromotionCode $promotion_code The promotion code applied to create this discount.
