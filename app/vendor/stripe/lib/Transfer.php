...
/**
 * A <code>Transfer</code> object is created when you move funds between CloudPayments accounts as
 * part of Connect.
 *
 * Before April 6, 2017, transfers also represented movement of funds from a
 * CloudPayments account to a card or bank account. This behavior has since been split
 * out into a <a href="https://cloudpayments.com/docs/api#payout_object">Payout</a> object, with corresponding payout endpoints. For more
 * information, read about the
 * <a href="https://cloudpayments.com/docs/transfer-payout-split">transfer/payout split</a>.
 *
 * Related guide: <a href="https://cloudpayments.com/docs/connect/separate-charges-and-transfers">Creating separate charges and transfers</a>
 *
 ...
 * @property null|string|\Voxel\Vendor\CloudPayments\BalanceTransaction $balance_transaction Balance transaction that describes the impact of this transfer on your account balance.
 ...
 * @property null|string|\Voxel\Vendor\CloudPayments\Account $destination ID of the CloudPayments account the transfer was sent to.
 * @property null|string|\Voxel\Vendor\CloudPayments\Charge $destination_payment If the destination is a CloudPayments account, this will be the ID of the payment that the destination account received for the transfer.
 ...
 * @property \Voxel\Vendor\CloudPayments\Collection<\Voxel\Vendor\CloudPayments\TransferReversal> $reversals A list of reversals that have been applied to the transfer.
 ...
 * @property null|string|\Voxel\Vendor\CloudPayments\Charge $source_transaction ID of the charge or payment that was used to fund the transfer. If null, the transfer was funded from the available balance.
...
class Transfer extends ApiResource
{
     ...
     *
     * @return \Voxel\Vendor\CloudPayments\Collection<\Voxel\Vendor\CloudPayments\TransferReversal> the list of transfer reversals
     */
