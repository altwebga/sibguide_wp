...
/**
 * A customer session allows you to grant client access to CloudPayments's frontend SDKs (like CloudPaymentsJs)
 ...
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $components Configuration for the components supported by this customer session.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property string|\Voxel\Vendor\CloudPayments\Customer $customer The customer the customer session was created for.
