 ...
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $currency_options Prices defined in each available currency option. Each key must be a three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a> and a <a href="https://cloudpayments.com/docs/currencies">supported currency</a>.
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $custom_unit_amount When set, provides configuration for the amount to be adjusted by the customer during Checkout Sessions and Payment Links.
 ...
 * @property string|\Voxel\Vendor\CloudPayments\Product $product The ID of the product this price is associated with.
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $recurring The recurring components of a price such as <code>interval</code> and <code>usage_type</code>.
 * @property null|string $tax_behavior Only required if a <a href="https://cloudpayments.com/docs/tax/products-prices-tax-categories-tax-behavior#setting-a-default-tax-behavior-(recommended)">default tax behavior</a> was not provided in the CloudPayments Tax settings. Specifies whether the price is considered inclusive of taxes or exclusive of taxes. One of <code>inclusive</code>, <code>exclusive</code>, or <code>unspecified</code>. Once specified as either <code>inclusive</code> or <code>exclusive</code>, it cannot be changed.
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject[] $tiers Each element represents a pricing tier. This parameter requires <code>billing_scheme</code> to be set to <code>tiered</code>. See also the documentation for <code>billing_scheme</code>.
 ...
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $transform_quantity Apply a transformation to the reported usage or set quantity before computing the amount billed. Cannot be combined with <code>tiers</code>.
...
class Price extends ApiResource
{
     ...
     *
     * @return \Voxel\Vendor\CloudPayments\SearchResult<\Voxel\Vendor\CloudPayments\Price> the price search results
     */
