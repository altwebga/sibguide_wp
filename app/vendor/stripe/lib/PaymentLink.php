 ...
 * @property \Voxel\Vendor\Stripe\StripeObject $after_completion
 * @property bool $allow_promotion_codes Whether user redeemable promotion codes are enabled.
 * @property null|string|\Voxel\Vendor\Stripe\StripeObject $application The ID of the Connect application that created the Payment Link.
 ...
 * @property null|\Voxel\Vendor\Stripe\StripeObject $consent_collection When set, provides configuration to gather active consent from customers.
 ...
 * @property null|\Voxel\Vendor\Stripe\StripeObject $invoice_creation Configuration for creating invoice for payment mode payment links.
 * @property null|\Voxel\Vendor\Stripe\Collection<\Voxel\Vendor\Stripe\LineItem> $line_items The line items representing what is being sold.
 ...
 * @property null|\Voxel\Vendor\Stripe\StripeObject $payment_intent_data Indicates the parameters to be passed to PaymentIntent creation during checkout.
 ...
 * @property \Voxel\Vendor\Stripe\StripeObject $phone_number_collection
 * @property null|\Voxel\Vendor\Stripe\StripeObject $restrictions Settings that restrict the usage of a payment link.
 * @property null|\Voxel\Vendor\Stripe\StripeObject $shipping_address_collection Configuration for collecting the customer's shipping address.
 * @property \Voxel\Vendor\Stripe\StripeObject[] $shipping_options The shipping rate options applied to the session.
 ...
 * @property null|\Voxel\Vendor\Stripe\StripeObject $subscription_data When creating a subscription, the specified configuration data will be used. There must be at least one line item with a recurring price to use <code>subscription_data</code>.
 * @property \Voxel\Vendor\Stripe\StripeObject $tax_id_collection
 * @property null|\Voxel\Vendor\Stripe\StripeObject $transfer_data The account (if any) the payments will be attributed to for tax reporting, and where funds from each payment will be transferred to.
