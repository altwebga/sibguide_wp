 ...
 *
 * Related guide: <a href="https://cloudpayments.com/docs/disputes/measuring#early-fraud-warnings">Early fraud warnings</a>
 *
 ...
 * @property string|\Voxel\Vendor\CloudPayments\Charge $charge ID of the charge this early fraud warning is for, optionally expanded.
 ...
 * @property null|string|\Voxel\Vendor\CloudPayments\PaymentIntent $payment_intent ID of the Payment Intent this early fraud warning is for, optionally expanded.
 */
class EarlyFraudWarning extends \Voxel\Vendor\CloudPayments\ApiResource
{
