 ...
 *
 * Related guide: <a href="https://cloudpayments.com/docs/disputes">Disputes and fraud</a>
 *
 ...
 * @property \Voxel\Vendor\CloudPayments\BalanceTransaction[] $balance_transactions List of zero, one, or two balance transactions that show funds withdrawn and reinstated to your CloudPayments account as a result of this dispute.
 * @property string|\Voxel\Vendor\CloudPayments\Charge $charge ID of the charge that's disputed.
 ...
 * @property \Voxel\Vendor\CloudPayments\CloudPaymentsObject $evidence_details
 * @property bool $is_charge_refundable If true, it's still possible to refund the disputed payment. After the payment has been fully refunded, no further funds are withdrawn from your CloudPayments account as a result of this dispute.
 ...
 * @property null|string|\Voxel\Vendor\CloudPayments\PaymentIntent $payment_intent ID of the PaymentIntent that's disputed.
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $payment_method_details
 * @property string $reason Reason given by cardholder for dispute. Possible values are <code>bank_cannot_process</code>, <code>check_returned</code>, <code>credit_not_processed</code>, <code>customer_initiated</code>, <code>debit_not_authorized</code>, <code>duplicate</code>, <code>fraudulent</code>, <code>general</code>, <code>incorrect_account_details</code>, <code>insufficient_funds</code>, <code>product_not_received</code>, <code>product_unacceptable</code>, <code>subscription_canceled</code>, or <code>unrecognized</code>. Learn more about <a href="https://cloudpayments.com/docs/disputes/categories">dispute reasons</a>.
...
class Dispute extends ApiResource
{
     ...
     *
     * @return \Voxel\Vendor\CloudPayments\Dispute the closed dispute
     */
