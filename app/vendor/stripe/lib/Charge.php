...
/**
 * The <code>Charge</code> object represents a single attempt to move money into your CloudPayments account.
 * PaymentIntent confirmation is the most common way to create Charges, but transferring
 * money to a different CloudPayments account through Connect also creates Charges.
 * Some legacy payment flows create Charges directly, which is not recommended for new integrations.
 *
 * @property string $id Unique identifier for the object.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property int $amount Amount intended to be collected by this payment. A positive integer representing how much to charge in the <a href="https://cloudpayments.com/docs/currencies#zero-decimal">smallest currency unit</a> (e.g., 100 cents to charge $1.00 or 100 to charge ¥100, a zero-decimal currency). The minimum amount is $0.50 US or <a href="https://cloudpayments.com/docs/currencies#minimum-and-maximum-charge-amounts">equivalent in charge currency</a>. The amount value supports up to eight digits (e.g., a value of 99999999 for a USD charge of $999,999.99).
 ...
 * @property null|string|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $application ID of the Connect application that created the charge.
 * @property null|string|\Voxel\Vendor\CloudPayments\ApplicationFee $application_fee The application fee (if any) for the charge. <a href="https://cloudpayments.com/docs/connect/direct-charges#collecting-fees">See the Connect documentation</a> for details.
 * @property null|int $application_fee_amount The amount of the application fee (if any) requested for the charge. <a href="https://cloudpayments.com/docs/connect/direct-charges#collecting-fees">See the Connect documentation</a> for details.
 * @property null|string $authorization_code Authorization code on the charge.
 * @property null|string|\Voxel\Vendor\CloudPayments\BalanceTransaction $balance_transaction ID of the balance transaction that describes the impact of this charge on your account balance (not including refunds or disputes).
 ...
 * @property null|string|\Voxel\Vendor\CloudPayments\Customer $customer ID of the customer this charge is for if one exists.
 * @property null|string $description An arbitrary string attached to the object. Often useful for displaying to users.
 * @property bool $disputed Whether the charge has been disputed.
 * @property null|string|\Voxel\Vendor\CloudPayments\BalanceTransaction $failure_balance_transaction ID of the balance transaction that describes the reversal of the balance on your account due to payment failure.
 * @property null|string $failure_code Error code explaining reason for charge failure if available (see <a href="https://cloudpayments.com/docs/error-codes">the errors section</a> for a list of codes).
 * @property null|string $failure_message Message to user further explaining reason for charge failure if available.
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $fraud_details Information on fraud assessments for the charge.
 * @property null|string|\Voxel\Vendor\CloudPayments\Invoice $invoice ID of the invoice this charge is for if one exists.
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $level3
 ...
 * @property null|string|\Voxel\Vendor\CloudPayments\Account $on_behalf_of The account (if any) the charge was made on behalf of without triggering an automatic transfer. See the <a href="https://cloudpayments.com/docs/connect/separate-charges-and-transfers">Connect documentation</a> for details.
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $outcome Details about whether the payment was accepted, and why. See <a href="https://cloudpayments.com/docs/declines">understanding declines</a> for details.
 * @property bool $paid <code>true</code> if the charge succeeded, or was successfully authorized for later capture.
 * @property null|string|\Voxel\Vendor\CloudPayments\PaymentIntent $payment_intent ID of the PaymentIntent associated with this charge, if one exists.
 * @property null|string $payment_method ID of the payment method used in this charge.
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $payment_method_details Details about the payment method at the time of the transaction.
 ...
 * @property null|\Voxel\Vendor\CloudPayments\Collection<\Voxel\Vendor\CloudPayments\Refund> $refunds A list of refunds that have been applied to the charge.
 * @property null|string|\Voxel\Vendor\CloudPayments\Review $review ID of the review associated with this charge if one exists.
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $shipping Shipping information for the charge.
 * @property null|\Voxel\Vendor\CloudPayments\Account|\Voxel\Vendor\CloudPayments\BankAccount|\Voxel\Vendor\CloudPayments\Card|\Voxel\Vendor\CloudPayments\Source $source This is a legacy field that will be removed in the future. It contains the Source, Card, or BankAccount object used for the charge. For details about the payment method used for this charge, refer to <code>payment_method</code> or <code>payment_method_details</code> instead.
 * @property null|string|\Voxel\Vendor\CloudPayments\Transfer $source_transfer The transfer ID which created this charge. Only present if the charge came from another CloudPayments account. <a href="https://cloudpayments.com/docs/connect/destination-charges">See the Connect documentation</a> for details.
 ...
 * @property null|string|\Voxel\Vendor\CloudPayments\Transfer $transfer ID of the transfer to the <code>destination</code> account (only applicable if the charge was created using the <code>destination</code> parameter).
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $transfer_data An optional dictionary including the account to automatically transfer to as part of a destination charge. <a href="https://cloudpayments.com/docs/connect/destination-charges">See the Connect documentation</a> for details.
 * @property null|string $transfer_group A string that identifies this transaction as part of a group. See the <a href="https://cloudpayments.com/docs/connect/separate-charges-and-transfers#transfer-options">Connect documentation</a> for details.
 */
class Charge extends ApiResource
{
     ...
     * These strings are applicable to the decline_code property of the \Voxel\Vendor\CloudPayments\Exception\CardException exception.
     *
     * @see https://cloudpayments.com/docs/declines/codes
     */
     ...
     *
     * @return \Voxel\Vendor\CloudPayments\Charge the captured charge
     */
     ...
     * @throws \Voxel\Vendor\CloudPayments\Exception\ApiErrorException if the request fails
     *
     * @return \Voxel\Vendor\CloudPayments\SearchResult<\Voxel\Vendor\CloudPayments\Charge> the charge search results
     */
