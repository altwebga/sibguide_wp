 ...
 * might want to apply to a customer. Coupons may be applied to <a href="https://cloudpayments.com/docs/api#subscriptions">subscriptions</a>, <a href="https://cloudpayments.com/docs/api#invoices">invoices</a>,
 ...
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $applies_to
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property null|string $currency If <code>amount_off</code> has been set, the three-letter <a href="https://cloudpayments.com/docs/currencies">ISO code for the currency</a> of the amount to take off.
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $currency_options Coupons defined in each available currency option. Each key must be a three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a> and a <a href="https://cloudpayments.com/docs/currencies">supported currency</a>.
