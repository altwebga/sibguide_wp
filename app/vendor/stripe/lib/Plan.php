...
/**
 * You can now model subscriptions more flexibly using the <a href="https://cloudpayments.com/docs/api#prices">Prices API</a>. It replaces the Plans API and is backwards compatible to simplify your migration.
 *
 ...
 *
 * Related guides: <a href="https://cloudpayments.com/docs/billing/subscriptions/set-up-subscription">Set up a subscription</a> and more about <a href="https://cloudpayments.com/docs/products-prices/overview">products and prices</a>.
 *
 ...
 * @property null|string|\Voxel\Vendor\CloudPayments\Product $product The product whose pricing this plan determines.
 ...
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $transform_usage Apply a transformation to the reported usage or set quantity before computing the amount billed. Cannot be combined with <code>tiers</code>.
 * @property null|int $trial_period_days Default number of trial days when subscribing a customer to this plan using <a href="https://cloudpayments.com/docs/api#create_subscription-trial_from_plan"><code>trial_from_plan=true</code></a>.
