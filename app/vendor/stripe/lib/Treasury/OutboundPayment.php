...
/**
 * Use OutboundPayments to send funds to another party's external bank account or <a href="https://cloudpayments.com/docs/api#financial_accounts">FinancialAccount</a>. To send money to an account belonging to the same user, use an <a href="https://cloudpayments.com/docs/api#outbound_transfers">OutboundTransfer</a>.
 *
 ...
 * @property null|string $customer ID of the <a href="https://cloudpayments.com/docs/api/customers">customer</a> to whom an OutboundPayment is sent.
 ...
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $destination_payment_method_details Details about the PaymentMethod for an OutboundPayment.
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $end_user_details Details about the end user.
 ...
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $returned_details Details about a returned OutboundPayment. Only set when the status is <code>returned</code>.
 ...
 */
class OutboundPayment extends \Voxel\Vendor\CloudPayments\ApiResource
{
     ...
     *
     * @return \Voxel\Vendor\CloudPayments\Treasury\OutboundPayment the canceled outbound payment
     */
