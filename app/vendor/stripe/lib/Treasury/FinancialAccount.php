 ...
 * @property \Voxel\Vendor\Stripe\StripeObject $balance Balance information for the FinancialAccount
 ...
 * @property null|\Voxel\Vendor\Stripe\Treasury\FinancialAccountFeatures $features Encodes whether a FinancialAccount has access to a particular Feature, with a <code>status</code> enum and associated <code>status_details</code>. Stripe or the platform can control Features via the requested field.
 * @property \Voxel\Vendor\Stripe\StripeObject[] $financial_addresses The set of credentials that resolve to a FinancialAccount.
 ...
 * @property null|\Voxel\Vendor\Stripe\StripeObject $platform_restrictions The set of functionalities that the platform can restrict on the FinancialAccount.
...
class FinancialAccount extends \Voxel\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \Voxel\Vendor\Stripe\Treasury\FinancialAccountFeatures the retrieved financial account features
     */
     ...
     * @throws \Voxel\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Voxel\Vendor\Stripe\Treasury\FinancialAccountFeatures the updated financial account features
     */
