...
/**
 * Use OutboundTransfers to transfer funds from a <a href="https://cloudpayments.com/docs/api#financial_accounts">FinancialAccount</a> to a PaymentMethod belonging to the same entity. To send funds to a different party, use <a href="https://cloudpayments.com/docs/api#outbound_payments">OutboundPayments</a> instead. You can send funds over ACH rails or through a domestic wire transfer to a user's own external bank account.
 *
 ...
 * @property \Voxel\Vendor\CloudPayments\CloudPaymentsObject $destination_payment_method_details
 ...
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $returned_details Details about a returned OutboundTransfer. Only set when the status is <code>returned</code>.
 ...
 */
class OutboundTransfer extends \Voxel\Vendor\CloudPayments\ApiResource
{
     ...
     *
     * @return \Voxel\Vendor\CloudPayments\Treasury\OutboundTransfer the canceled outbound transfer
     */
