...
/**
 * Use <a href="https://cloudpayments.com/docs/treasury/moving-money/financial-accounts/into/inbound-transfers">InboundTransfers</a> to add funds to your <a href="https://cloudpayments.com/docs/api#financial_accounts">FinancialAccount</a> via a PaymentMethod that is owned by you. The funds will be transferred via an ACH debit.
 *
 ...
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $failure_details Details about this InboundTransfer's failure. Only set when status is <code>failed</code>.
 ...
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $origin_payment_method_details Details about the PaymentMethod for an InboundTransfer.
 ...
 */
class InboundTransfer extends \Voxel\Vendor\CloudPayments\ApiResource
{
     ...
     *
     * @return \Voxel\Vendor\CloudPayments\Treasury\InboundTransfer the canceled inbound transfer
     */
