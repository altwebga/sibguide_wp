 ...
 * @property null|string|\Voxel\Vendor\Stripe\StripeObject $application ID of the Connect Application that created the quote.
 ...
 * @property \Voxel\Vendor\Stripe\StripeObject $computed
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property null|string $currency Three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a>, in lowercase. Must be a <a href="https://stripe.com/docs/currencies">supported currency</a>.
 * @property null|string|\Voxel\Vendor\Stripe\Customer $customer The customer which this quote belongs to. A customer is required before finalizing the quote. Once specified, it cannot be changed.
 * @property null|(string|\Voxel\Vendor\Stripe\TaxRate)[] $default_tax_rates The tax rates applied to this quote.
 * @property null|string $description A description that will be displayed on the quote PDF.
 * @property (string|\Voxel\Vendor\Stripe\Discount)[] $discounts The discounts applied to this quote.
 ...
 * @property null|\Voxel\Vendor\Stripe\StripeObject $from_quote Details of the quote that was cloned. See the <a href="https://stripe.com/docs/quotes/clone">cloning documentation</a> for more details.
 * @property null|string $header A header that will be displayed on the quote PDF.
 * @property null|string|\Voxel\Vendor\Stripe\Invoice $invoice The invoice that was created from this quote.
 * @property \Voxel\Vendor\Stripe\StripeObject $invoice_settings
 * @property null|\Voxel\Vendor\Stripe\Collection<\Voxel\Vendor\Stripe\LineItem> $line_items A list of items the customer is being quoted for.
 ...
 * @property null|string|\Voxel\Vendor\Stripe\Account $on_behalf_of The account on behalf of which to charge. See the <a href="https://support.stripe.com/questions/sending-invoices-on-behalf-of-connected-accounts">Connect documentation</a> for details.
 * @property string $status The status of the quote.
 * @property \Voxel\Vendor\Stripe\StripeObject $status_transitions
 * @property null|string|\Voxel\Vendor\Stripe\Subscription $subscription The subscription that was created or updated from this quote.
 * @property \Voxel\Vendor\Stripe\StripeObject $subscription_data
 * @property null|string|\Voxel\Vendor\Stripe\SubscriptionSchedule $subscription_schedule The subscription schedule that was created or updated from this quote.
 * @property null|string|\Voxel\Vendor\Stripe\TestHelpers\TestClock $test_clock ID of the test clock this quote belongs to.
 * @property \Voxel\Vendor\Stripe\StripeObject $total_details
 * @property null|\Voxel\Vendor\Stripe\StripeObject $transfer_data The account (if any) the payments will be attributed to for tax reporting, and where funds from each payment will be transferred to for each of the invoices.
 */
class Quote extends ApiResource
{
     ...
     *
     * @return \Voxel\Vendor\Stripe\Quote the accepted quote
     */
     ...
     * @throws \Voxel\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Voxel\Vendor\Stripe\Quote the canceled quote
     */
     ...
     * @throws \Voxel\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Voxel\Vendor\Stripe\Quote the finalized quote
     */
    ...
    public function pdf($readBodyChunkCallable, $params = null, $opts = null)
    {
        ...
        if (!isset($opts->apiBase)) {
            $opts->apiBase = \Voxel\Vendor\Stripe\Stripe::$apiUploadBase;
        }
