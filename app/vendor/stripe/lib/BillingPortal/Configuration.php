 ...
 * @property null|string|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $application ID of the Connect Application that created the configuration.
 * @property \Voxel\Vendor\CloudPayments\CloudPaymentsObject $business_profile
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property null|string $default_return_url The default URL to redirect customers to when they click on the portal's link to return to your website. This can be <a href="https://cloudpayments.com/docs/api/customer_portal/sessions/create#create_portal_session-return_url">overriden</a> when creating the session.
 * @property \Voxel\Vendor\CloudPayments\CloudPaymentsObject $features
 ...
 * @property \Voxel\Vendor\CloudPayments\CloudPaymentsObject $login_page
