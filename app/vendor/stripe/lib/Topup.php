...
/**
 * To top up your CloudPayments balance, you create a top-up object. You can retrieve
 * individual top-ups, as well as list all top-ups. Top-ups are identified by a
 * unique, random ID.
 *
 * Related guide: <a href="https://cloudpayments.com/docs/connect/top-ups">Topping up your platform account</a>
 *
 * @property string $id Unique identifier for the object.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property int $amount Amount transferred.
 * @property null|string|\Voxel\Vendor\CloudPayments\BalanceTransaction $balance_transaction ID of the balance transaction that describes the impact of this top-up on your account balance. May not be specified depending on status of top-up.
 ...
 * @property null|int $expected_availability_date Date the funds are expected to arrive in your CloudPayments account for payouts. This factors in delays like weekends or bank holidays. May not be specified depending on status of top-up.
 * @property null|string $failure_code Error code explaining reason for top-up failure if available (see <a href="https://cloudpayments.com/docs/api#errors">the errors section</a> for a list of codes).
 ...
 * @property null|\Voxel\Vendor\CloudPayments\Source $source The source field is deprecated. It might not always be present in the API response.
...
class Topup extends ApiResource
{
     ...
     *
     * @return \Voxel\Vendor\CloudPayments\Topup the canceled topup
     */
