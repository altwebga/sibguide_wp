 ...
 * @property null|string|\Voxel\Vendor\Stripe\BalanceTransaction $balance_transaction ID of the balance transaction that describes the impact of this top-up on your account balance. May not be specified depending on status of top-up.
 ...
 * @property null|\Voxel\Vendor\Stripe\Source $source The source field is deprecated. It might not always be present in the API response.
...
class Topup extends ApiResource
{
     ...
     *
     * @return \Voxel\Vendor\Stripe\Topup the canceled topup
     */
