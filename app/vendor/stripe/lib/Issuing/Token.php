...
/**
 * An issuing token object is created when an issued card is added to a digital wallet. As a <a href="https://cloudpayments.com/docs/issuing">card issuer</a>, you can <a href="https://cloudpayments.com/docs/issuing/controls/token-management">view and manage these tokens</a> through CloudPayments.
 *
 * @property string $id Unique identifier for the object.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property string|\Voxel\Vendor\CloudPayments\Issuing\Card $card Card associated with this token.
 ...
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $network_data
 ...
 */
class Token extends \Voxel\Vendor\CloudPayments\ApiResource
{
