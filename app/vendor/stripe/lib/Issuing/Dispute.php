 ...
 * @property null|\Voxel\Vendor\Stripe\BalanceTransaction[] $balance_transactions List of balance transactions associated with the dispute.
 ...
 * @property string|\Voxel\Vendor\Stripe\Issuing\Transaction $transaction The transaction being disputed.
 * @property null|\Voxel\Vendor\Stripe\StripeObject $treasury <a href="https://stripe.com/docs/api/treasury">Treasury</a> details related to this dispute if it was created on a [FinancialAccount](/docs/api/treasury/financial_accounts
 */
class Dispute extends \Voxel\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \Voxel\Vendor\Stripe\Issuing\Dispute the submited dispute
     */
