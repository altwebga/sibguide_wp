...
/**
 * You can <a href="https://cloudpayments.com/docs/issuing/cards">create physical or virtual cards</a> that are issued to cardholders.
 *
 ...
 * @property \Voxel\Vendor\CloudPayments\Issuing\Cardholder $cardholder <p>An Issuing <code>Cardholder</code> object represents an individual or business entity who is <a href="https://cloudpayments.com/docs/issuing">issued</a> cards.</p><p>Related guide: <a href="https://cloudpayments.com/docs/issuing/cards#create-cardholder">How to create a cardholder</a></p>
 ...
 * @property null|string $cvc The card's CVC. For security reasons, this is only available for virtual cards, and will be omitted unless you explicitly request it with <a href="https://cloudpayments.com/docs/api/expanding_objects">the <code>expand</code> parameter</a>. Additionally, it's only available via the <a href="https://cloudpayments.com/docs/api/issuing/cards/retrieve">&quot;Retrieve a card&quot; endpoint</a>, not via &quot;List all cards&quot; or any other endpoint.
 ...
 * @property null|string $number The full unredacted card number. For security reasons, this is only available for virtual cards, and will be omitted unless you explicitly request it with <a href="https://cloudpayments.com/docs/api/expanding_objects">the <code>expand</code> parameter</a>. Additionally, it's only available via the <a href="https://cloudpayments.com/docs/api/issuing/cards/retrieve">&quot;Retrieve a card&quot; endpoint</a>, not via &quot;List all cards&quot; or any other endpoint.
 * @property null|string|\Voxel\Vendor\CloudPayments\Issuing\Card $replaced_by The latest card that replaces this card, if any.
 * @property null|string|\Voxel\Vendor\CloudPayments\Issuing\Card $replacement_for The card this card replaces, if any.
 * @property null|string $replacement_reason The reason why the previous card needed to be replaced.
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $shipping Where and how the card will be shipped.
 * @property \Voxel\Vendor\CloudPayments\CloudPaymentsObject $spending_controls
 ...
 * @property null|\Voxel\Vendor\CloudPayments\CloudPaymentsObject $wallets Information relating to digital wallets (like Apple Pay and Google Pay).
 */
class Card extends \Voxel\Vendor\CloudPayments\ApiResource
{
