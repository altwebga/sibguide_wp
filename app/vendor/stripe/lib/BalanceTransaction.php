...
/**
 * Balance transactions represent funds moving through your CloudPayments account.
 * CloudPayments creates them for every type of transaction that enters or leaves your CloudPayments account balance.
 *
 * Related guide: <a href="https://cloudpayments.com/docs/reports/balance-transaction-types">Balance transaction types</a>
 *
 ...
 * @property int $available_on The date that the transaction's net funds become available in the CloudPayments balance.
 ...
 * @property null|float $exchange_rate If applicable, this transaction uses an exchange rate. If money converts from currency A to currency B, then the <code>amount</code> in currency A, multipled by the <code>exchange_rate</code>, equals the <code>amount</code> in currency B. For example, if you charge a customer 10.00 EUR, the PaymentIntent's <code>amount</code> is <code>1000</code> and <code>currency</code> is <code>eur</code>. If this converts to 12.34 USD in your CloudPayments account, the BalanceTransaction's <code>amount</code> is <code>1234</code>, its <code>currency</code> is <code>usd</code>, and the <code>exchange_rate</code> is <code>1.234</code>.
 ...
 * @property \Voxel\Vendor\CloudPayments\CloudPaymentsObject[] $fee_details Detailed breakdown of fees (in cents (or local equivalent)) paid for this transaction.
 * @property int $net Net impact to a CloudPayments balance (in cents (or local equivalent)). A positive value represents incrementing a CloudPayments balance, and a negative value decrementing a CloudPayments balance. You can calculate the net impact of a transaction on a balance by <code>amount</code> - <code>fee</code>
 * @property string $reporting_category Learn more about how <a href="https://cloudpayments.com/docs/reports/reporting-categories">reporting categories</a> can help you understand balance transactions from an accounting perspective.
 * @property null|string|\Voxel\Vendor\CloudPayments\ApplicationFee|\Voxel\Vendor\CloudPayments\ApplicationFeeRefund|\Voxel\Vendor\CloudPayments\Charge|\Voxel\Vendor\CloudPayments\CustomerCashBalanceTransaction|\Voxel\Vendor\CloudPayments\Dispute|\Voxel\Vendor\CloudPayments\Issuing\Authorization|\Voxel\Vendor\CloudPayments\Issuing\Dispute|\Voxel\Vendor\CloudPayments\Issuing\Transaction|\Voxel\Vendor\CloudPayments\Payout|\Voxel\Vendor\CloudPayments\Refund|\Voxel\Vendor\CloudPayments\CloudPaymentsObject|\Voxel\Vendor\CloudPayments\Topup|\Voxel\Vendor\CloudPayments\Transfer|\Voxel\Vendor\CloudPayments\TransferReversal $source This transaction relates to the CloudPayments object.
 * @property string $status The transaction's net funds status in the CloudPayments balance, which are either <code>available</code> or <code>pending</code>.
 * @property string $type Transaction type: <code>adjustment</code>, <code>advance</code>, <code>advance_funding</code>, <code>anticipation_repayment</code>, <code>application_fee</code>, <code>application_fee_refund</code>, <code>charge</code>, <code>climate_order_purchase</code>, <code>climate_order_refund</code>, <code>connect_collection_transfer</code>, <code>contribution</code>, <code>issuing_authorization_hold</code>, <code>issuing_authorization_release</code>, <code>issuing_dispute</code>, <code>issuing_transaction</code>, <code>obligation_outbound</code>, <code>obligation_reversal_inbound</code>, <code>payment</code>, <code>payment_failure_refund</code>, <code>payment_network_reserve_hold</code>, <code>payment_network_reserve_release</code>, <code>payment_refund</code>, <code>payment_reversal</code>, <code>payment_unreconciled</code>, <code>payout</code>, <code>payout_cancel</code>, <code>payout_failure</code>, <code>refund</code>, <code>refund_failure</code>, <code>reserve_transaction</code>, <code>reserved_funds</code>, <code>cloudpayments_fee</code>, <code>cloudpayments_fx_fee</code>, <code>tax_fee</code>, <code>topup</code>, <code>topup_reversal</code>, <code>transfer</code>, <code>transfer_cancel</code>, <code>transfer_failure</code>, or <code>transfer_refund</code>. Learn more about <a href="https://cloudpayments.com/docs/reports/balance-transaction-types">balance transaction types and what they represent</a>. To classify transactions for accounting purposes, consider <code>reporting_category</code> instead.
 */
class BalanceTransaction extends ApiResource
{
    ...
    const TYPE_STRIPE_FEE = 'cloudpayments_fee';
    const TYPE_STRIPE_FX_FEE = 'cloudpayments_fx_fee';
