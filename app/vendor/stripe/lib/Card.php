 ...
 * @property null|string|\Voxel\Vendor\Stripe\Account $account The account this card belongs to. This attribute will not be in the card object if the card belongs to a customer or recipient instead.
 ...
 * @property null|string|\Voxel\Vendor\Stripe\Customer $customer The customer that this card belongs to. This attribute will not be in the card object if the card belongs to an account or recipient instead.
 ...
 * @property null|\Voxel\Vendor\Stripe\StripeObject $networks
