 ...
 * @property null|string|\Voxel\Vendor\Stripe\StripeObject $application The value of <a href="https://stripe.com/docs/api/setup_intents/object#setup_intent_object-application">application</a> on the SetupIntent at the time of this confirmation.
 ...
 * @property null|string|\Voxel\Vendor\Stripe\Customer $customer The value of <a href="https://stripe.com/docs/api/setup_intents/object#setup_intent_object-customer">customer</a> on the SetupIntent at the time of this confirmation.
 ...
 * @property null|string|\Voxel\Vendor\Stripe\Account $on_behalf_of The value of <a href="https://stripe.com/docs/api/setup_intents/object#setup_intent_object-on_behalf_of">on_behalf_of</a> on the SetupIntent at the time of this confirmation.
 * @property string|\Voxel\Vendor\Stripe\PaymentMethod $payment_method ID of the payment method used with this SetupAttempt.
 * @property \Voxel\Vendor\Stripe\StripeObject $payment_method_details
 * @property null|\Voxel\Vendor\Stripe\StripeObject $setup_error The error encountered during this attempt to confirm the SetupIntent, if any.
 * @property string|\Voxel\Vendor\Stripe\SetupIntent $setup_intent ID of the SetupIntent that this attempt belongs to.
