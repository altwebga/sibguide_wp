	...
	public static function query( array $args ) {
		...
		if ( $args['calculate_count'] ) {
			return absint( $wpdb->get_var( "
				SELECT COUNT(*) AS total_count FROM {$wpdb->prefix}vx_orders AS orders
				{$joins}
				{$wheres}
			" ) );
		}
