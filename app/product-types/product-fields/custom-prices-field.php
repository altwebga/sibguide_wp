		...
		$schema->set_prop( 'custom_prices', Schema::Object( [
			...
			'list' => Schema::Object_List( [
				...
				'conditions' => Schema::Object_List( [
					...
					'date' => Schema::Date()->format('Y-m-d')->min(time() - DAY_IN_SECONDS),
					'range' => Schema::Object( [
						'from' => Schema::Date()->format('Y-m-d')->min(time() - DAY_IN_SECONDS),
						'to' => Schema::Date()->format('Y-m-d')->min(time() - DAY_IN_SECONDS),
					] ),
				] )->default([]),
